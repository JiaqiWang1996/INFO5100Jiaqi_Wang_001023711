...
public class MainJFrame extends javax.swing.JFrame {
    ...
    public MainJFrame() {
        initComponents();
        this.carDirectory=new CarDirectory();//when an obj is created,a new instance created
    }
    ...
    private void initComponents() {
        ...
        topJPanel.setBackground(new java.awt.Color(204, 255, 153));

        btnAccountMng.setFont(new java.awt.Font("宋体", 1, 14)); // NOI18N
        btnAccountMng.setText("Manage Your Account");
    ...
    private void btnAccountMngActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccountMngActionPerformed
        // TODO add your handling code here:
         AccountMngWorkAreaJPanel panel=new AccountMngWorkAreaJPanel(userProcessContainer,carDirectory);
