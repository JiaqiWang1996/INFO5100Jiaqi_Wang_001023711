...
public class Lab7 {
    ...
    private void runAnalysis(){
        // TODO
        helper.getAverageLikesPerCommets();//non-static,create instance
        helper.getpostWithMostLikedComments();
        helper.getpostWithMostComments();
        helper.Find_Top_5_inactive_users_based_on_total_posts_number();
        helper.Find_Top_5_inactive_users_based_on_total_comments_they_created();
        helper.Find_Top_5_inactive_users_overall__sum_of_comments_posts_and_likes();
        helper.Find_Top_5_proactive_users_overall___sum_of_comments_posts_and_likes();
    }
}
