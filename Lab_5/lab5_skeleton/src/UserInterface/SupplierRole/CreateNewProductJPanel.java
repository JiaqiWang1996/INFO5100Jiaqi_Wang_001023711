...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 110, 30));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 220, 110, 30));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (txtName.getText().length()==0||txtAvailability.getText().length()==0||txtPrice.getText().length()==0||txtAvailability.getText().replaceAll("[0-9]","").length()!=0||txtPrice.getText().replaceAll("[0-9]","").length()!=0||txtName.getText().length()!=txtName.getText().replaceAll("[0-9]","").length()) {
