...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        for(User user:list){
        if(user.getUserName().equals((String)comboUser.getSelectedItem())){
        if(user.getPassword().equals(txtPword.getText())){
          CardLayout layout = (CardLayout)panelRight.getLayout();
        panelRight.add(new SuccessScreen(user));
        layout.next(panelRight);
        }
        else{  JOptionPane.showMessageDialog(null, "Your password is imcomplete or invalid,please try again","Warning",JOptionPane.WARNING_MESSAGE);
        }
        }
        }
